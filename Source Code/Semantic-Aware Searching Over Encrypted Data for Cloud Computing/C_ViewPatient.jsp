      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            ...
            <p>&nbsp;</p>
			 <table width="923" height="91" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
              <tr>
                <th width="32" height="49" bgcolor="#FFFF00" scope="col"><div align="center" class="style34">ID</div></th>
                <th width="113" bgcolor="#FFFF00" scope="col"><div align="center" class="style34">PATIENT NAME </div></th>
                <th width="119" bgcolor="#FFFF00" scope="col"><div align="center" class="style34">BLOOD GROUP </div></th>
                <th width="81" bgcolor="#FFFF00" scope="col"><div align="center" class="style34">DISEASE</div></th>
                <th width="51" bgcolor="#FFFF00" scope="col"><div align="center" class="style34">AGE </div></th>
                <th width="78" bgcolor="#FFFF00" scope="col"><div align="center" class="style34">DOB</div></th>
                <th width="84" bgcolor="#FFFF00" scope="col"><div align="center" class="style34">GENDER</div></th>
                <th width="101" bgcolor="#FFFF00" scope="col"><div align="center" class="style34">EMAIL</div></th>
                <th width="81" bgcolor="#FFFF00" scope="col"><div align="center" class="style34">MOBILE</div></th>
                <th width="161" bgcolor="#FFFF00" scope="col"><div align="center" class="style34">VIEW DESCRIPTION </div></th>
              </tr>
            <%	  
...
try 
	{
			...
			while ( rs.next() )
			{
              ...
              <tr>
                ...
                <td><div align="center"><em><%=s5%></em></div></td>
                <td><div align="center"><em><%=s6%></em></div></td>
                <td><div align="center"><em><%=s7%></em></div></td>
                <td><div align="center"><em><%=s8%></em></div></td>
                <td><div align="center"><em><%=s9%></em></div></td>
                <td><div align="center"><a href="C_PatientDesc.jsp?usid=<%=i%>"><em>View Description</em></a></div></td>
              </tr>
			  <%
				}	
...
%>
            ...
            <table width="920" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><div align="right"><a href="C_Main.jsp" class="style32">Back</a></div></td>
              </tr>
            </table>
            <p>&nbsp;</p>
