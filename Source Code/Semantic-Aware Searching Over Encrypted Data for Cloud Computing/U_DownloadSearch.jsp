      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
	   	...
	   	%>
            ...
            <form action="U_Download1.jsp" method="post" id="form1">
              <table width="473" border="0" align="center">
                <tr>
                  <td width="223"><span class="style23 style18"><strong>Enter Name :-</strong></span></td>
                  <td width="245"><label>
                    <input required="required" name="t1" type="text" value="<%=fname%>" size="40" />
                    <input type="hidden" name="type"  value="<%=type%>" size="40" />
                  </label></td>
                </tr>
                <tr>
                  <td height="34"><span class="style23 style18"><strong>Trapdoor :-</strong></span></td>
          ...
          <div class="blog">
			...
			<li><a href="U_Search.jsp">Search</a></li><br />
			<li><a href="U_Profile.jsp">My Profile</a></li><br />
			<li><a href="U_Download.jsp">Download</a></li><br />
