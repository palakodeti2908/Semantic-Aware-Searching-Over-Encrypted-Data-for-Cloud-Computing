...
<div class="main">
  ...
  <div class="body">
	...
	{
		String msg="";
		String que="select * from patient_details where id='"+uid+"'";
		...
		if(rs.next())
		{
			...
			if(ptrap.equalsIgnoreCase("No"))
			{
					%>
              <h3 class="style31">Trapdoor <span class="style36">Not Generated For Patient Description </span> !! <br /></h3>
              <p>&nbsp;</p>
              <%
			}
			
				Statement st3=connection.createStatement();
				String quer="select * from patient_details_backup where patient_name='"+pname+"'";
				ResultSet rs3=st3.executeQuery(quer);
				if(rs3.next())
				{
				
					String p_name=rs3.getString(2);
					String p_desc=rs3.getString(11);
					String p_trap=rs3.getString(12);
					if(ptrap.equalsIgnoreCase(p_trap))
					{
						%>
              <h3 align="left" class="style31">Patient Description <span class="style36">Is Safe</span> !! And Free From Attackers .. </h3>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              ...
              <%
					...
					{
						%>
              <h3 align="left" class="style31">Patient Description <span class="style36"> Is Not Safe</span> !! <a href="O_RecoverPatientDesc.jsp?pname=<%=pname%>">Click Here</a> To Recover  .. </h3>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <div align="right"><a href="O_ViewPatientDetails.jsp" class="style34">Back</a><br />
              </div>
