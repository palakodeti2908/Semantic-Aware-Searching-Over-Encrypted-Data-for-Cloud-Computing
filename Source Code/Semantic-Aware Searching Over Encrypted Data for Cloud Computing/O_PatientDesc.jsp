...
try 
	{
            ...
            <table width="549" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
              ...
              <tr>
                ...
                <td><input readonly="readonly"  name="textfield2" type="text" size="49" value="<%=s7%>" />                </td>
              </tr>
			    <tr>
                <td height="36" bgcolor="#FF0000"><div align="center" class="style35">
                    <div align="left"><strong>Gender : </strong></div>
                </div></td>
                <td><input readonly="readonly"  name="textfield2" type="text" size="49" value="<%=s8%>" />                </td>
              </tr>
              <tr>
                <td height="186" bgcolor="#FF0000"><div align="center" class="style35">
                    <div align="left"><strong>Patient Description  :</strong></div>
                </div></td>
                <td><label>
              ...
              <tr>
                ...
                <td><input readonly="readonly"  name="textfield3" type="text" value="Not Generated" size="49" /></td>
              </tr>
              <%}else{%>
              <tr>
                <td height="36" bgcolor="#FF0000"><div align="center" class="style35">
...
%>
            ...
            <p>&nbsp;</p>
            <p align="right"><a href="O_UploadedDetails.jsp" class="style32">Back</a></p>
          </div>
          <div class="blog">
            <h2>Menu</h2>
