      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>Add Document  </h2>
            <p>&nbsp;</p>
            <form id="form1" name="form1" method="post" action="O_AddDocument1.jsp">
              <p>&nbsp;</p>
              <table width="553" border="0" align="center">
                <tr>
                  <td width="286" height="37" bgcolor="#FF0000"><span class="style7">Select File :-</span></td>
                  <td width="356"><input required="required" type="file" name="t42" id="file"  onchange="loadFileAsText()" /></td>
                </tr>
                <tr>
                  <td height="42" bgcolor="#FF0000" ><span class="style7">File Name :- </span></td>
                  <td><input required="required" name="tt" type="text" id="t42" size="49"/></td>
                </tr>
                <tr>
			    <tr>
                  <td height="42" bgcolor="#FF0000" ><span class="style7">Select Domain :- </span></td>
                  <td><label>
                    <select name="domain">
                      <option>Technology</option>
                      <option>Politics</option>
                      <option>Enteirtainment</option>
