          ...
          <div class="blogcont" >
            ...
            <form action="U_RegisterAuthentication.jsp" method="post" id="" enctype="multipart/form-data">
              ...
              <table width="590" height="524" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="259" bgcolor="#FF0000" scope="row">
                  <div align="left" class="style6">User Name (required) : </div></td>
                  <td width="343"><input id="name" name="userid" class="text" /></td>
                </tr>
                <tr>
                  <td bgcolor="#FF0000" ><div align="left" class="style6">Password (required) : </div></td>
                  <td><input type="password" id="password" name="pass" class="text" /></td>
                </tr>
                <tr>
                  <td bgcolor="#FF0000" scope="row"><div align="left" class="style6">Email Address (required) : </div></td>
                  <td><input id="email" name="email" class="text" /></td>
                </tr>
                <tr>
                  <td bgcolor="#FF0000" scope="row"><div align="left" class="style6">Mobile Number (required) : </div></td>
                  <td><input id="mobile" name="mobile" class="text" /></td>
                </tr>
                <tr>
                  <td bgcolor="#FF0000" scope="row">
                                      <span class="style6">
                                      <label for="label">                    </label>                    
                                      <label for="label">
                                      </span>
                                      <div align="left" class="style6">Your Address : </div>
                                      <span class="style6">
                                      </label>
                                      </span></td>
                ...
                <tr>
                  <td bgcolor="#FF0000" scope="row">
                                      ...
                                      <div align="left" class="style6">Date of Birth (required) : </div>
                                      <span class="style6">
                                      </label>
                                      </span></td>
                ...
                <tr>
                  <td bgcolor="#FF0000" scope="row"><div align="left" class="style6">Select Gender (required) : </div></td>
                ...
                <tr>
                  <td bgcolor="#FF0000" scope="row">
                                      ...
                                      <div align="left" class="style6">Enter Pincode (required) : </div>
                                      <span class="style6">
                                      </label>
                                      </span></td>
                ...
                <tr>
                  <td bgcolor="#FF0000" scope="row">
                                      ...
                                      <div align="left" class="style6">Enter Location (required) : </div>
                                      <span class="style6">
                                      </label>
                                      </span></td>
                ...
                <tr>
                  <td bgcolor="#FF0000" scope="row">
                                      ...
                                      <div align="left" class="style6">Select Profile Picture (required) : </div>
                                      <span class="style6">
                                      </label>
                                      </span></td>
