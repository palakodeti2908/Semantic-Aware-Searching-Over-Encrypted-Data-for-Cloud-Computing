...
.style34 {font-size: 12px; color: #FFFF00; }
-->
</style>
</head>
<body>
      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <span class="style29">Patient Details  With Trapdoor : </span>
            <p>&nbsp;</p>
            <%	  
...
try 
	{
      		String query="Select *from patient_details where patient_name='"+pname+"'"; 
            ...
            <table width="549" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
              <tr>
                <td width="142" height="36" bgcolor="#FF0000"><div align="center" class="style29 style32 style33">
              ...
              <tr>
                <td height="36" bgcolor="#FF0000"><div align="center" class="style34">
              ...
              <tr>
                ...
                <td><input readonly="readonly"  name="textfield3" type="text" value="<%=s3%>" size="49" /></td>
              </tr>
              <tr>
                <td height="36" bgcolor="#FF0000"><div align="center" class="style34">
              ...
              <tr>
                ...
                <td><input readonly="readonly"  name="textfield35" type="text" value="<%=s9%>" size="49" /></td>
              </tr>
              <tr>
                <td height="65" bgcolor="#FF0000"><div align="center" class="style34">
                  <div align="left"><strong>Address :</strong></div>
                </div></td>
                <td><textarea readonly="readonly" rows="3"  cols="50"  name="textarea2"><%=s10%></textarea></td>
              </tr>
              <tr>
                <td height="186" bgcolor="#FF0000"><div align="center" class="style34">
                    <div align="left"><strong>Description :</strong></div>
                </div></td>
                <td><label>
                  <textarea readonly="readonly" rows="10"  cols="50"  name="textarea"><%=s11%></textarea>
                  </label>                </td>
              </tr>
              <tr>
                <td height="36" bgcolor="#FF0000"><div align="center" class="style34">
                ...
                <td><input readonly="readonly"  name="textfield36" type="text" value="<%=s12%>" size="49" /></td>
              </tr>
              <tr>
                <td height="36" bgcolor="#FF0000"><div align="center" class="style34">
                  <div align="left"><strong>Secret Key  :</strong></div>
                </div></td>
                <td><input readonly="readonly"  name="textfield37" type="text" value="<%=s13%>" size="49" /></td>
              </tr>
              <tr>
                <td height="36" bgcolor="#FF0000"><div align="center" class="style34">
                  <div align="left"><strong>Date &amp; Time  :</strong></div>
                </div></td>
                <td><input readonly="readonly"  name="textfield38" type="text" value="<%=s14%>" size="49" /></td>
              </tr>
              <tr>
                <td height="36" bgcolor="#FF0000"><div align="center" class="style34">
                    <div align="left"><strong>Data Owner : </strong></div>
                </div></td>
                <td><input readonly="readonly"  name="textfield332" type="text" value="<%=s15%>" size="49" /></td>
              </tr>
              <%
