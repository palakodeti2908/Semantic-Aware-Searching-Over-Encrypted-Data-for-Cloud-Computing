...
<div class="main">
  ...
  <div class="body">
    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>Patient Description  Contents </h2>
            <p>&nbsp;</p>
	...
	int i=0,j=0,k=0;
String pname=request.getParameter("t142");	
try 
	{
            ...
            <form id="form2" name="form2" method="post" action="Attacker_Update.jsp">
              ...
              <table width="599" border="0" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                  ...
                  <td><label>
                    <textarea rows="10"  cols="65"  name="text"><%=s3%></textarea>
					<input  type="hidden"  name="type" value="Patient" />                    </label>
                  </td>
                </tr>
                <tr>
