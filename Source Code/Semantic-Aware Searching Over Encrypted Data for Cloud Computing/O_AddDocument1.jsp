      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>Add Document  </h2>
            <p>&nbsp;</p>
            <form action="O_AddDocument2.jsp" method="post">
              <p>
                <%
      	try {
...
%>
              ...
              <table width="580" border="0" align="center" style="border-collapse:collapse" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="176" height="34" bgcolor="#FF0000"><span class="style21">File Name : </span></td>
                  <td width="405"><input name="t42" type="text" id="t42" size="49" value="<%= file %>" readonly="readonly" /></td>
                </tr>
				 <tr>
                  <td height="42" bgcolor="#FF0000" ><span class="style21">Select Domain :- </span></td>
                  <td><label>
                  <input name="t422" type="text" id="t422" size="49" value="<%= domain %>" readonly="readonly" />
                  </label></td>
                </tr>
                
                <tr>
                  <td height="256" bgcolor="#FF0000"><span class="style21"><%=file%> Data(Encrypted) : </span></td>
