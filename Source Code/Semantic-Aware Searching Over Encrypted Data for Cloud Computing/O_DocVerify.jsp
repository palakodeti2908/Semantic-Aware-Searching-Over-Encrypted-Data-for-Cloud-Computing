...
<div class="main">
  ...
  <div class="body">
	...
	{
		String msg="";
		String que="select * from document where id='"+uid+"'";
		...
		if(rs.next())
		{
			...
			{
					%>
              <h3 class="style31">Trapdoor <span class="style36">Not Generated </span> !! <br /></h3>
              <p>&nbsp;</p>
              <%
			}
			
				Statement st3=connection.createStatement();
				String quer="select * from document_backup where fname='"+file+"'";
				ResultSet rs3=st3.executeQuery(quer);
				if(rs3.next())
				{
				
					String b_file=rs3.getString(2);
					String b_cont=rs3.getString(3);
					String b_trap=rs3.getString(4);
					if(b_cont.equalsIgnoreCase(cont))
					{
						%>
              <h3 align="left" class="style31">Document <span class="style36">Is Safe</span> !! And Free From Attackers .. </h3>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <div align="right"><a href="O_ViewDoc.jsp" class="style34">Back</a><br />
              </div>
              <%
					}
					else
					{
						%>
              <h3 align="left" class="style31">Document<span class="style36"> Is Not Safe</span> !! <a href="O_Recoverdoc.jsp?fname=<%=file%>">Click Here</a> To Recover  .. </h3>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <div align="right"><a href="O_ViewDoc.jsp" class="style34">Back</a><br />
              </div>
