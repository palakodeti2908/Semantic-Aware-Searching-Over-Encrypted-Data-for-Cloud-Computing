          ...
          <div class="blogcont" >
            ...
            <table width="567" border="1.5" cellpadding="0" style="border-collapse:collapse" cellspacing="0"  align="center">
              <tr>
                ...
                <td width="97" bgcolor="#FF0000"><div align="center" class="style31">Fname</div></td>
                <td width="128" bgcolor="#FF0000"><div align="center" class="style31">Attack Key </div></td>
                <td width="104" bgcolor="#FF0000"><div align="center" class="style31">Attack Type </div></td>
              </tr>
              <%
...
%>
            ...
            <table width="567" border="1.5" cellpadding="0" style="border-collapse:collapse" cellspacing="0"  align="center">
              <tr>
                <td width="27" height="30" bgcolor="#FFFF00"><div align="center" class="style32"> ID </div></td>
                <td width="89" bgcolor="#FFFF00"><div align="center" class="style32">User Name </div></td>
                <td width="100" bgcolor="#FFFF00"><div align="center" class="style32">Fname</div></td>
                <td width="124" bgcolor="#FFFF00"><div align="center" class="style32">Type</div></td>
                <td width="101" bgcolor="#FFFF00"><div align="center" class="style32">Attack Type</div></td>
              </tr>
              <%
