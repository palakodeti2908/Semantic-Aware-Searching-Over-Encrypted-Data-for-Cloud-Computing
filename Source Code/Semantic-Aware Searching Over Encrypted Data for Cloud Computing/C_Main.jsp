    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>Welcome Cloud </h2>
            <p><img src="images/Cloud.jpg" width="546" height="336" /></p>
            <p>&nbsp;</p>
          </div>
          <div class="blog">
            <h2>Menu</h2>
			...
			<li><a href="C_ViewDoc.jsp">View Documents</a></li><br />
			<li><a href="C_ViewPatient.jsp">View Patient Details</a></li><br />
			<li><a href="C_SearchPer.jsp">Search Permissions</a></li><br />
			<li><a href="C_SearchedKeywords.jsp">Top Searched Keywords</a></li><br />
			<li><a href="C_SearchChart.jsp">Search Keyword Chart</a></li><br />
			<li><a href="C_FileChart.jsp">View File Rank Chart</a></li>
			<br />
