    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>Patient Trapdoor Response </h2>
            <p>&nbsp;</p>

            <p><strong>Enter Patient Name And View Patient Trapdoor Permission Response:            </strong></p>
			<p align="justify">&nbsp;</p>
			<form id="form" name="form1" method="post" action="U_Res_Patient_Trap1.jsp">
        ...
        <br />
        <br />
        <input type="submit" name="Submit" value="View Trapdoor" />
                <p>&nbsp; </p>
              </div>
		    </form>
			<%String key=(String)application.getAttribute("key");
			  if(key!=(null))
			  {%>
            <p align="center" class="style12"><strong><span class="style12">Trapdoor</span> :</strong> <span class="style12"><%=key%> </span></p>
            <%application.removeAttribute("key");
			  }%>
            <p align="right"><a href="U_Trapdoor.jsp">Back</a></p>
            <p align="justify">&nbsp;</p>
          </div>
          <div class="blog">
            <h2>Menu</h2>
