...
<%
					...
					if ( rs1.next() )
					   ...
					   {
					  PreparedStatement ps=connection.prepareStatement("insert into user(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status,p_search_req,f_search_req) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
