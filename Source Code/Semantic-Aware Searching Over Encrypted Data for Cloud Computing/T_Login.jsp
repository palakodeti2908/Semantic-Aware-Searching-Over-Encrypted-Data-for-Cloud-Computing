...
<head>
<title>Trapdoor Generation Centre Login</title>
...
<div class="main">
  <div class="header_resize">
    <div class="header">
      <div class="logo">
        <h1 class="style1 style33">Semantic based Compound Keyword Search over Encrypted Cloud Data</h1>
      </div>
      <div class="menu">
        <ul>
          ...
          <li><a href="T_Login.jsp" class="active">TRUSTED AUTHORITY </a></li>
    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2 class="style6">Trapdoor Generation Centre </h2>
            <p>&nbsp;</p>
            <form action="T_Authentication.jsp" method="post" id="leavereply">
              <label for="name"> <br />
