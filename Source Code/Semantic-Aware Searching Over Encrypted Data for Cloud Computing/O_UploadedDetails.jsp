    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>View Uploaded Documents (OR) Patient Details </h2>
            <p>&nbsp;</p>
            <h3><a href="O_ViewDoc.jsp">View Documents</a></h3>
			
			<h3><a href="O_ViewPatientDetails.jsp">View Patient Details  </a></h3>
			
			<p><img src="images/img_1.jpg" alt="" width="274" height="116" /></p><p align="right"><a href="O_Main.jsp">Back</a></p>
          </div>
          <div class="blog">
            <h2>Menu</h2>
