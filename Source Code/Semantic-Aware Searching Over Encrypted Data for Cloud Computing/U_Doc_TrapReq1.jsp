      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            ...
            <p><strong>Request For  Document Trapdoor From <span class="style19">Trapdoor Generation Centre</span>: </strong></p>
            <p>&nbsp;</p>
...
<%
	...
	{	  
		...
		String dt = strDate + "   " + strTime;
		  ...
		  String query="Select *from document_request where user='"+user+"' and owner='"+dname+"' and fname='"+fname+"' and (f_trapdoor_req='Requested'||f_trapdoor_req='Permitted')";
	      Statement st=connection.createStatement();
          ResultSet rs=st.executeQuery(query);
		  if (rs.next())
		  {
			%>
			<h3><span class="style7">Document Trapdoor Request Already Sent To <span class="style23">Trapdoor Generation Centre</span> !! </span> </h3>
			<p>&nbsp;</p>
		  ...
		  {
		  	 String query1="Select * from document where fname='"+fname+"' and downer='"+dname+"'";	  
			 Statement st1=connection.createStatement();
			 ResultSet rs1=st1.executeQuery(query1);
			 if (rs1.next())
			 {
				
					String query2="Select * from document_request where user='"+user+"' and owner='"+dname+"' and fname='"+fname+"'";	  
					Statement st2=connection.createStatement();
					ResultSet rs2=st2.executeQuery(query2);
					if (rs2.next())
					{
						int id=rs2.getInt(1);
						String query3="update document_request set f_trapdoor_req='Requested' where user='"+user+"' and owner='"+dname+"' and fname='"+fname+"'";
						Statement st3=connection.createStatement();
						st3.executeUpdate(query3);
						%>
						<h3><span class="style7">Document Trapdoor Request  Sent Sucessfully To <span class="style23">Trapdoor Generation Centre</span>  !! </span> </h3>
						<p>&nbsp;</p>
					...
					{
						String query3="insert into document_request(user,owner,fname,f_trapdoor_req) values('"+user+"','"+dname+"','"+fname+"','Requested')";
						Statement st3=connection.createStatement();
						st3.executeUpdate(query3);
						%>
						<h3><span class="style7"> Document Trapdoor Request  Sent Sucessfully To <span class="style23">Trapdoor Generation Centre</span>  !! </span> </h3>
			  ...
			  {
				%><span class="style7"><h3>Document Not Found !! </h3></span> 
				<p>&nbsp;</p>
			<p><a href="U_Main.jsp">Back</a></p>
				<%
			  }
