      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            ...
            <p><img src="images/Owner.jpg" width="559" height="245" /></p>
          </div>
          <div class="blog">
            <h2>Menu</h2>
			...
			<li><a href="O_AddPatientDetails.jsp">Add Patient Details</a></li><br />
			<li><a href="O_UploadedDetails.jsp">View Uploaded and Verify Details</a></li>
			<br />
			<li><a href="O_Login.jsp">Logout</a></li>
			<br />
			</ul></span>
