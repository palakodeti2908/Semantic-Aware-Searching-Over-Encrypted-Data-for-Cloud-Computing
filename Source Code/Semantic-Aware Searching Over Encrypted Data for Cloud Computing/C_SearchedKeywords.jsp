...
<div class="main">
  ...
  <div class="body">
        ...
        <div class="body_resize_bottom">
          <div class="blogcont" >
            ...
            <table width="589" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
              <tr>
                <td width="136" height="31" bgcolor="#FF0000"><div align="center" class="style22 style23">User</div></td>
                <td width="232" bgcolor="#FF0000"><div align="center" class="style24">Keyword </div></td>
                <td width="211" bgcolor="#FF0000"><div align="center" class="style24">Count</div></td>
              </tr>
              <%
      	...
      	try 
	{
      		...
      		String query="SELECT user,keyword,count(keyword) FROM Semantic_Based.search group by keyword,user order by count(keyword) desc"; 
