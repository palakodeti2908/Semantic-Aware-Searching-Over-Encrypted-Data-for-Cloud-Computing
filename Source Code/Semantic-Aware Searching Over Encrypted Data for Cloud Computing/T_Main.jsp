...
<head>
<title>(Main)Trapdoor Generation Centre</title>
    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>TRUSTED AUTHORITY </h2>
            <p><img src="images/Trusted.png" width="516" height="203" /></p>
            <p>&nbsp;</p>
          </div>
          <div class="blog">
            <h2>Menu</h2>
			...
			<li><a href="T_ViewFiles.jsp">View Files</a></li><br />
			<li><a href="T_ViewTransactions.jsp">View Transactions</a></li><br />
			<li><a href="T_TrapdoorGen.jsp">Generate Trapdoor</a></li><br />
			<li><a href="T_Login.jsp">Logout</a></li><br />
			</ul></span>
			</h5>
          </div>
          <div class="clr"></div>
