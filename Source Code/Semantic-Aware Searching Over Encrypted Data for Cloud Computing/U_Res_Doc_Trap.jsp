    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>Document Trapdoor Response </h2>
            <p>&nbsp;</p>

            <p><strong>Enter Document Name And View Document Trapdoor Permission Response:            </strong></p>
			<p align="justify">&nbsp;</p>
			<form id="form" name="form1" method="post" action="U_Res_Doc_Trap1.jsp">
