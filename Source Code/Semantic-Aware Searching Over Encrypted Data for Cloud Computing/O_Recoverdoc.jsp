...
<div class="main">
  ...
  <div class="body">
	...
	{
		String msg="";
		String que="select * from document_backup where fname='"+fname+"'";
		Statement st=connection.createStatement();
		ResultSet rs=st.executeQuery(que);
		if(rs.next())
		{
			String f_name=rs.getString(2);
			String fcont=rs.getString(3);
			String ftrap=rs.getString(4);
			
						
				Statement st3=connection.createStatement();
				String quer="update document set ct='"+fcont+"' , trapdoor ='"+ftrap+"' where fname='"+fname+"'";
				int rs3=st3.executeUpdate(quer);
				if(rs3>0)
				{
				
						%>
              <h3 align="left" class="style31">Document <span class="style36">Recovered Successfully</span> !!  .. </h3>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
