  ...
  <div class="body">
    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2><span><span class="style31">Document Delete Status</span><a href="DO_Login.jsp"></a></span></h2>
            <p class="infopost">&nbsp;</p>
            <div class="img"></div>
	...
	try 
	{
		...
		if(rs.next())
		{
			...
			st3.executeUpdate("delete from document_backup where fname='"+file+"'");
			String quer="delete from document where fname='"+file+"'";
			int rs3=st3.executeUpdate(quer);
			if(rs3==1)
			{
				%>
              <h3 class="style31">Document Deleted  Sucessfully !!</h3>
              <a href="O_ViewDoc.jsp" class="style34">Back</a><br />
              <%
			}
			else
			{
				%>
              <h3 class="style31">Document Not Found !!</h3>
              <a href="O_ViewDoc.jsp" class="style34">Back</a><br />
              <%
			}
		}
