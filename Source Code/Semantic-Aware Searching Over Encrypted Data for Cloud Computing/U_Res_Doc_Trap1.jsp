...
<%
	...
	try
	{
		String sql1="SELECT * FROM document where fname='"+fname+"'";
		Statement stmt1 = connection.createStatement();
		ResultSet rs1 =stmt1.executeQuery(sql1);
		if(rs1.next())
		{
			String sql="SELECT * FROM document_request where user='"+uname+"' and fname='"+fname+"'";
			...
			if(rs.next())
			{
				...
				if (key.equalsIgnoreCase("No"))
				{
					...
					response.sendRedirect("U_Res_Doc_Trap.jsp");
				}
				...
				{
					String sql2="SELECT * FROM document where fname='"+fname+"'";
					Statement stmt2 = connection.createStatement();
					ResultSet rs2 =stmt2.executeQuery(sql2);
					if(rs2.next())
					{		
					   String mskey = rs2.getString(4);
