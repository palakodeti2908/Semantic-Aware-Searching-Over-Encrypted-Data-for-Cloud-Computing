    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>Request Search Permission </h2>
            <p>&nbsp;</p>

            <p><strong>Request Serach Permission For Documents &amp; Patient Details:            </strong></p>
			<p>&nbsp;</p><p>&nbsp;</p>

			
            <span class="style10">Click Here For<a href="U_Doc_SearchReq.jsp"><strong> Document Search Permission</strong></a> <span class="style11">Request</span> <br />
            <br />
			<span class="style10"><br />
			<br />
            <br />
            Click Here For<a href="U_Patient_SearchReq.jsp"><strong> Patient Details Search Permission</strong></a> <span class="style11">Request</span>	<br />
            <br />
</span></span>
            <p>&nbsp;</p>
