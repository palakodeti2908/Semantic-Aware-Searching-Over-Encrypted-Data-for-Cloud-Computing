      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>Attacker Page </h2>
            <p>&nbsp;</p>
            <span class="style29"> Enter Document Name To View Document Contents : </span>
            <p>&nbsp;</p>
            <form id="form" name="form1" method="post" action="Attacker_doc.jsp">
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <span class="style29"> Enter Patient Name To View Patient Descriptions : </span>
            <p>&nbsp;</p>
            <form id="form" name="form1" method="post" action="Attacker_patient.jsp">
              <div align="center" class="style21">
                <br />
                  Enter Patient Name :
                    <input required="required" name="t142" type="text" size="30" />
                <br />
                    <br />
                    <input type="submit" name="Submit2" value="View Description" />
                </p>
                <p ></p>
              </div>
              <p>&nbsp;</p>
