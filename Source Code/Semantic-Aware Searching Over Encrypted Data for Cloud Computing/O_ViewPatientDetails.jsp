      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            ...
            <p>&nbsp;</p>
            <table width="916" height="75" border="1" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
              <tr height="32">
                <th width="25" bgcolor="#FF0000"  scope="col"><div align="center" class="style33">
                  <div align="center">ID</div>
                </div></th>
                <th width="125" bgcolor="#FF0000" scope="col"><div align="center" class="style33">
                  <div align="center">PATIENT NAME </div>
                </div></th>
                <th width="121" bgcolor="#FF0000" scope="col"><div align="center" class="style33">
                  <div align="center">BLOOD GROUP </div>
                </div></th>
                <th width="89" bgcolor="#FF0000" scope="col"><div align="center" class="style33">
                  <div align="center">DISEASE</div>
                </div></th>
                <th width="122" bgcolor="#FF0000" scope="col"><div align="center" class="style33">
                  <div align="center">EMAIL</div>
                </div></th>
                <th width="108" bgcolor="#FF0000" scope="col"><div align="center" class="style33">
                  <div align="center">MOBILE</div>
                </div></th>
                <th width="77" bgcolor="#FF0000" scope="col"><div align="center" class="style33">
                  <div align="center">DELETE</div>
                </div></th>
                <th width="81" bgcolor="#FF0000" scope="col"><div align="center" class="style33">
                  <div align="center">VERIFY</div>
                </div></th>
                <th width="148" bgcolor="#FF0000" scope="col"><div align="center" class="style33">
                  <div align="center">VIEW DESCRIPTION </div>
                </div></th>
              </tr>
              <%	  
...
try 
	{
      		String query="Select *from patient_details where downer='"+doname+"' "; 
			...
			while ( rs.next() )
			{
					...
					s9=rs.getString(9);
						...
						%>
              <tr height="30">
                <td><div align="center"><em><%=i%></em></div></td>
                <td><div align="center"><em><%=s2%></em></div></td>
                <td><div align="center"><em><%=s3%></em></div></td>
                <td><div align="center"><em><%=s4%></em></div></td>
                <td><div align="center"><em><%=s8%></em></div></td>
                <td><div align="center"><em><%=s9%></em></div></td>
                <td><div align="center"><a href="O_P_DetailsDelete.jsp?usid=<%=i%>"><input name="Input" type="button" value="Delete" /></a></div></td>
                <td><div align="center"><a href="O_P_DetailsVerify.jsp?usid=<%=i%>"><input name="Input2" type="button" value="Verify" /></a></div></td>
                <td><div align="center"><a href="O_PatientDesc.jsp?usid=<%=i%>"><em>View Description</em></a></div></td>
              </tr>
              <%
				}	
...
%>
            ...
            <table width="920" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><div align="right"><a href="O_UploadedDetails.jsp" class="style32">Back</a></div></td>
              </tr>
            </table>
            <p>&nbsp;</p>
