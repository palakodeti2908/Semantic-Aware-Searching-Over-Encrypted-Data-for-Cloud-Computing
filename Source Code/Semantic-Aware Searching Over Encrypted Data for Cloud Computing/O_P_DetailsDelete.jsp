...
.style6 {color: #343434}
.style33 {color: #161616}
.style31 {font-size: 24px}
.style34 {	color: #A1006F;
	font-size: 16px;
}
  ...
  <div class="body">
    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2><span><span class="style31">Patient Details Delete Status</span><a href="DO_Login.jsp"></a></span></h2>
            <p class="infopost">&nbsp;</p>
            <div class="img"></div>
	...
	try 
	{
		...
		if(rs.next())
		{
			...
			String strQuery2 = "insert into transaction(user,fname,task,dt) values('"+dname+"','"+"Patient-"+p_name+"','"+task+"','"+dt+"')";
			st.executeUpdate(strQuery2);
			
			Statement st3=connection.createStatement();
			st3.executeUpdate("delete from patient_details_backup where patient_name='"+p_name+"'");
			String quer="delete from patient_details where patient_name='"+p_name+"'";
			int rs3=st3.executeUpdate(quer);
			if(rs3==1)
			{
				%>
              <h3 class="style31">&nbsp;</h3>
              <h3 class="style31">Patient <%=p_name%>'s Details Removed Sucessfully !!</h3>
              <a href="O_ViewPatientDetails.jsp">Back</a><br />
              <%
			}
			else
			{
				%>
              <h3 class="style31">Details Not Found !!</h3>
              <a href="O_ViewPatientDetails.jsp">Back</a>
              <%
			}
		}
	}
