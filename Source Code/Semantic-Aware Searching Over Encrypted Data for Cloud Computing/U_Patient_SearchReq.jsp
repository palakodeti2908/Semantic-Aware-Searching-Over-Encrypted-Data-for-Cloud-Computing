      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            ...
            <p><strong>Request For  Patient Search Permission:            </strong></p>
            <p>&nbsp;</p>
            <div class="post_content">
              <p>&nbsp;</p>
              <form id="form1" name="form1" method="post" action="U_Patient_SearchReq1.jsp">
                <label>
			  ...
			  if(msg!=(null))
			  {%>
                <div align="center" class="style4"><strong> Status : <%=msg%>&nbsp;</strong></div>
                <%application.removeAttribute("msg");
			  }%>
              </form>
              <p>&nbsp;</p>
              <form id="form2" name="form2" method="post" action="U_View_p_SearchPer.jsp">
                <label>
                <input type="submit" name="Submit2" value="View Response" />
                </label>
              </form>
              <p></p>
              <p align="right"><a href="U_Search_Per.jsp">Back</a></p>
            </div>
          </div>
          <div class="blog">
            <h2>Menu</h2>
