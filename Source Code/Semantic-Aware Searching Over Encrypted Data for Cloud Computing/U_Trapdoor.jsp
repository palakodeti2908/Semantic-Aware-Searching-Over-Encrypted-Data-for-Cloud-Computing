      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            ...
            <br /><br />
          Click Here For<a href="U_Patient_TrapReq.jsp"><strong> Patient Description </strong></a><a href="U_Doc_SearchReq.jsp"><strong>Trapdoor</strong></a> <span class="style11">Request</span> </span>
		  <br /><br />
		  Click Here For<a href="U_Res_Patient_Trap.jsp"><strong> Patient Description </strong></a><a href="U_Doc_SearchReq.jsp"><strong>Trapdoor</strong></a> Response</span>
