    ...
    <div class="body_resize">
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            <h2>Search   </h2>
            <p><span class="style7">Enter Patient Name To Search Patient Details (OR) Enter Document Name To Search On Document : </span>         
              <br />
            </p>
            <p><br />
            </p>
            <p class="infopost">&nbsp;</p>
            <strong><a href="U_PatientSearch.jsp" class="style21">Search For Patient Details</a><br />
            <br />
            <br />
            <a href="U_DocumentSearch.jsp" class="style22">Search For Documents </a> <br />
            </strong>
            <p>&nbsp;</p>
