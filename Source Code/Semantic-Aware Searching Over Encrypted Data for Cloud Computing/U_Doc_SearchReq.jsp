      ...
      <div class="body_resize_top">
        <div class="body_resize_bottom">
          <div class="blogcont" >
            ...
            <p><strong>Request For  Document Search Permission:            </strong></p>
            <p>&nbsp;</p>
            <div class="post_content">
              <p>&nbsp;</p>
              <form id="form1" name="form1" method="post" action="U_Doc_SearchReq1.jsp">
                <label>
              ...
              <p>&nbsp;</p>
              <form id="form2" name="form2" method="post" action="U_View_f_SearchPer.jsp">
                <label>
