        ...
        <div class="body_resize_bottom">
          <div class="blogcont" >
            ...
            <table width="567" border="1.5" cellpadding="0" style="border-collapse:collapse" cellspacing="0"  align="center">
              <tr>
                <td width="26" height="30" bgcolor="#FF0000"><div align="center" class="style23 style30"> ID </div></td>
                <td width="86" bgcolor="#FF0000"><div align="center" class="style31">User Name </div></td>
                <td width="97" bgcolor="#FF0000"><div align="center" class="style31">Email</div></td>
                <td width="128" bgcolor="#FF0000"><div align="center" class="style31">Login Access </div></td>
                <td width="104" bgcolor="#FF0000"><div align="center" class="style31">Permission</div></td>
              </tr>
              <%
...
%>
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <span class="style29">Grant Permissions For Patient Search Requests :            </span>
            <p>&nbsp;</p>
            <table width="567" border="1.5" cellpadding="0" style="border-collapse:collapse" cellspacing="0"  align="center">
              <tr>
                <td width="27" height="30" bgcolor="#FF0000"><div align="center" class="style31"> ID </div></td>
                <td width="89" bgcolor="#FF0000"><div align="center" class="style31">User Name </div></td>
                <td width="100" bgcolor="#FF0000"><div align="center" class="style31">Email</div></td>
                <td width="124" bgcolor="#FF0000"><div align="center" class="style31">Login Access </div></td>
                <td width="101" bgcolor="#FF0000"><div align="center" class="style31">Permission</div></td>
              </tr>
              <%
